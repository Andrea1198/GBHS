...
MANUAL=" Usage
 ...
 Na_epsilon, Mg_epsilon, Mg_spin_epsilon, Ar_epsilon
...
case $INPUT in 
   ...
   (Mg_spin_epsilon)run_Mg_spin_eps=yes ;;
   ...
   (all)            run_H=yes ;  run_He=yes ; run_He_spin=yes ; 
                    ...
                    run_Na_eps=yes ; run_Mg_eps=yes ; run_Mg_spin_eps=yes ; run_Ar_eps=yes ; 
...
if [ "$run_Mg_spin" = "yes" ] ; then
    $AGWX_BIN/agf.x < run_Mg_spin.in > run_Mg_spin.out
fi
#
if [ "$run_Ar" = "yes" ] ; then
...
if [ "$run_Mg_spin_eps" = "yes" ] ; then
    $AGWX_BIN/agf.x < run_Mg_spin_epsilon.in > run_Mg_spin_epsilon.out
fi
#
...
#
#
if [ "$run_He_sflda" = "yes" ] ; then
    $AGWX_BIN/agf.x < run_He_sflda.in > run_He_sflda.out
fi
if [ "$run_Be_sflda" = "yes" ] ; then
    $AGWX_BIN/agf.x < run_Be_sflda.in > run_Be_sflda.out
fi
