...
!--------------------------------------------------
   ...
   IF ( ionode ) THEN
       ...
       WRITE( stdout, "(/,2x,70('=') )" ) 
       WRITE( stdout, "(a)" ) '              =                                            ='
       WRITE( stdout, "(a)" ) '              =         *** AGWX *** Atomic GWX code       ='
       WRITE( stdout, "(a)" ) '              =       HF, MP2, ShamSchluter, PZSIC, GW.    ='
       WRITE( stdout, "(a)" ) '              =                                            ='
...
#ifdef __PYTHON
       !
       WRITE( stdout, '(5X,"Python support:    ",a)' ) "yes"
       !
#endif
       WRITE( stdout, "(/)")
   ENDIF
